...
1. "ADD_TRANSACTION": Quando o usuário registra uma entrada/venda (RECEITA) ou saída/gasto/compra (DESPESA).
...
2. "ADD_PAYABLE": Quando o usuário registra um compromisso financeiro/conta a pagar futura a FORNECEDORES ou FUNCIONÁRIOS.
...
4. "MARK_PAYABLE_PAID": Quando o usuário avisa que pagou uma conta a pagar de fornecedor/funcionário previamente agendada.
   - Exemplo: "Paguei o fornecedor de farinha", "Paguei o salário da Juliana".
...
Exemplo 2 (Conta a Pagar de Fornecedor):
